...
.. raw:: html
    ...
    <li> <span class="li-head">icap_profile</span> - Configure ICAP profiles. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">response_204</span> - Enable/disable allowance of 204 response from ICAP server. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span> </li>
        <li> <span class="li-head">size_limit_204</span> - 204 response size limit to be saved by ICAP client in megabytes (1 - 10). <span class="li-normal">type: int</span> </li>
        <li> <span class="li-head">chunk_encap</span> - Enable/disable chunked encapsulation . <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">extension_feature</span> - Enable/disable ICAP extension features. <span class="li-normal">type: list</span> <span class="li-normal">choices: scan-progress</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">file_transfer</span> - Configure the file transfer protocols to pass transferred files to an ICAP server as REQMOD. <span class="li-normal">type: list</span> <span class="li-normal">choices: ssh, ftp</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">file_transfer_failure</span> - Action to take if the ICAP server cannot be contacted when processing a file transfer. <span class="li-normal">type: str</span> <span class="li-normal">choices: error, bypass</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">file_transfer_path</span> - Path component of the ICAP URI that identifies the file transfer processing service. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">file_transfer_server</span> - ICAP server to use for a file transfer. Source icap.server.name icap.server-group.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">icap_block_log</span> - Enable/disable UTM log when infection found . <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">icap_headers</span> - Configure ICAP forwarded request headers. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">id</span> - HTTP forwarded header ID. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">methods</span> - The allowed HTTP methods that will be sent to ICAP server for further processing. <span class="li-normal">type: list</span> <span class="li-normal">choices: delete, get, head, options, post, put, trace, connect, other</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - ICAP profile name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">respmod_forward_rules</span> - ICAP response mode forward rules. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">header_group</span> - HTTP header group. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">http_resp_status_code</span> - HTTP response status code. <span class="li-normal">type: int</span>
