...
.. raw:: html
 ...
 <tr>
 <td>fortios_emailfilter_profile</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">emailfilter_profile</span> - Configure Email Filter profiles. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">external</span> - Enable/disable external Email inspection. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">log_all</span> - Enable/disable logging of all email traffic. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">tag_msg</span> - Subject text or header added to spam email. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">msn_hotmail</span> - MSN Hotmail. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">options</span> - Options. <span class="li-normal">type: list</span> <span class="li-normal">choices: bannedword, spambal, spamfsip, spamfssubmit, spamfschksum, spamfsurl, spamhelodns, spamraddrdns, spamrbl, spamhdrcheck, spamfsphish, spambwl</span>
 ...
 <td>n/a</td>
        ...
        <li> <span class="li-head">other_webmails</span> - Other supported webmails. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">hdrip</span> - Enable/disable SMTP email header IP checks for spamfsip, spamrbl, and spambal filters. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">local_override</span> - Enable/disable local filter to override SMTP remote check result. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_bal_table</span> - Anti-spam block/allow list table ID. Source emailfilter.block-allow-list.id. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_bwl_table</span> - Anti-spam black/white list table ID. Source emailfilter.bwl.id. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_bword_table</span> - Anti-spam banned word table ID. Source emailfilter.bword.id. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_bword_threshold</span> - Spam banned word threshold. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_filtering</span> - Enable/disable spam filtering. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_iptrust_table</span> - Anti-spam IP trust table ID. Source emailfilter.iptrust.id. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_log</span> - Enable/disable spam logging for email filtering. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_log_fortiguard_response</span> - Enable/disable logging FortiGuard spam response. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <tr>
 <td>spam_log_fortiguard_response</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_mheader_table</span> - Anti-spam MIME header table ID. Source emailfilter.mheader.id. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_rbl_table</span> - Anti-spam DNSBL table ID. Source emailfilter.dnsbl.id. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">yahoo_mail</span> - Yahoo! Mail. <span class="li-normal">type: dict</span>
