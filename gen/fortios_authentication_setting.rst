:source: fortios_authentication_setting.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_authentication_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">authentication_setting</span> - Configure authentication setting. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">active_auth_scheme</span> - Active authentication method (scheme name). Source authentication.scheme.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">auth_https</span> - Enable/disable redirecting HTTP user authentication to HTTPS. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">captive_portal</span> - Captive portal host name. Source firewall.address.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">captive_portal_ip</span> - Captive portal IP address. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">captive_portal_ip6</span> - Captive portal IPv6 address. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">captive_portal_port</span> - Captive portal port number (1 - 65535). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">captive_portal_ssl_port</span> - Captive portal SSL port number (1 - 65535). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">captive_portal_type</span> - Captive portal type. <span class="li-normal">type: str</span> <span class="li-normal">choices: fqdn, ip</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">captive_portal6</span> - IPv6 captive portal host name. Source firewall.address6.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cert_auth</span> - Enable/disable redirecting certificate authentication to HTTPS portal. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cert_captive_portal</span> - Certificate captive portal host name. Source firewall.address.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cert_captive_portal_ip</span> - Certificate captive portal IP address. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cert_captive_portal_port</span> - Certificate captive portal port number (1 - 65535). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cookie_max_age</span> - Persistent web portal cookie maximum age in minutes (30 - 10080 (1 week)). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cookie_refresh_div</span> - Refresh rate divider of persistent web portal cookie . Refresh value = cookie-max-age/cookie-refresh-div. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">dev_range</span> - Address range for the IP based device query. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">user_cert_ca</span> - CA certificate used for client certificate verification. <span class="li-normal">type: str</span>
