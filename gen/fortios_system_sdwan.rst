...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">duplication</span> - Create SD-WAN duplication rule. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">dstaddr</span> - Destination address or address group names. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">dstaddr6</span> - Destination address6 or address6 group names. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">dstintf</span> - Outgoing (egress) interfaces or zones. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">name</span> - Interface, zone or SDWAN zone name. Source system.interface.name system.zone.name system.sdwan.zone.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">id</span> - Duplication rule ID (1 - 255). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">service</span> - Service and service group name. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">name</span> - Service and service group name. Source firewall.service.custom.name firewall.service.group.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">service_id</span> - SD-WAN service rule ID list. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">id</span> - SD-WAN service rule ID. Source system.sdwan.service.id. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">srcaddr</span> - Source address or address group names. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">srcaddr6</span> - Source address6 or address6 group names. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">srcintf</span> - Incoming (ingress) interfaces or zones. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">detect_mode</span> - The mode determining how to detect the server. <span class="li-normal">type: str</span> <span class="li-normal">choices: active, passive, prefer-passive, remote</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">interval</span> - Status check interval in milliseconds, or the time between attempting to connect to the server (500 - 3600*1000 msec). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">seq_num</span> - Member sequence number. Source system.sdwan.members.seq-num. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">packet_size</span> - Packet size of a TWAMP test session. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">probe_timeout</span> - Time to wait before a probe packet is considered lost (500 - 3600*1000 msec). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">protocol</span> - Protocol used to determine if the FortiGate can communicate with the server. <span class="li-normal">type: str</span> <span class="li-normal">choices: ping, tcp-echo, udp-echo, http, twamp, dns, tcp-connect, ftp, ping6</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">server</span> - IP address or FQDN name of the server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
                ...
                <li> <span class="li-head">link_cost_factor</span> - Criteria on which to base link selection. <span class="li-normal">type: str</span> <span class="li-normal">choices: latency, jitter, packet-loss, mos</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">members</span> - FortiGate interfaces added to the SD-WAN. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">seq_num</span> - Sequence number(1-512). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">ip</span> - IP/IPv6 address of neighbor. Source router.bgp.neighbor.ip. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">member</span> - Member sequence number list. Source system.sdwan.members.seq-num. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">health_check</span> - Health check list. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">name</span> - Health check name. Source system.sdwan.health-check.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">input_zone</span> - Source input-zone name. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">name</span> - Zone. Source system.sdwan.zone.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">internet_service_app_ctrl_category</span> - IDs of one or more application control categories. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">id</span> - Application control category ID. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">internet_service_name</span> - Internet service name list. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">priority_zone</span> - Priority zone name list. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">name</span> - Priority zone name. Source system.sdwan.zone.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">health_check</span> - SD-WAN health-check. Source system.sdwan.health-check.name. <span class="li-normal">type: str</span>
